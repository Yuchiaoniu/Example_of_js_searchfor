...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 移除元素
    if (userzone) userzone.parentNode.removeChild(userzone);
    if (trial) trial.parentNode.removeChild(trial);
    if (generateButton) generateButton.parentNode.removeChild(generateButton);
});
